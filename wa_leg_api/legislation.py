...
def get_legislation(bill_number:int,biennium:str=None) -> Dict:
    """Auto-generated python interface to Washington State Legislature Web Services
    See http://wslwebservices.leg.wa.gov/lwsDetails.htm"""
...
def get_legislative_status_changes_by_bill_number(bill_number:int,begin_date:datetime,end_date:datetime,biennium:str=None) -> Dict:
    """Auto-generated python interface to Washington State Legislature Web Services
    See http://wslwebservices.leg.wa.gov/lwsDetails.htm"""
...
def get_legislative_status_changes_by_bill_id(begin_date:datetime,end_date:datetime,biennium:str=None,bill_id:str=None) -> Dict:
    """Auto-generated python interface to Washington State Legislature Web Services
    See http://wslwebservices.leg.wa.gov/lwsDetails.htm"""
...
def get_legislative_status_changes_by_date_range(begin_date:datetime,end_date:datetime,biennium:str=None) -> Dict:
    """Auto-generated python interface to Washington State Legislature Web Services
    See http://wslwebservices.leg.wa.gov/lwsDetails.htm"""
...
def get_legislation_not_yet_introduced_in_house_of_origin(biennium:str=None) -> Dict:
    """Auto-generated python interface to Washington State Legislature Web Services
    See http://wslwebservices.leg.wa.gov/lwsDetails.htm"""
    return waleg.call("Legislation", "GetLegislationNotYetIntroducedInHouseOfOrigin", argdict=dict(biennium=biennium))


def get_legislation_passed_original_body_and_not_introduced_in_opposite_body(biennium:str=None) -> Dict:
    """Auto-generated python interface to Washington State Legislature Web Services
    See http://wslwebservices.leg.wa.gov/lwsDetails.htm"""
